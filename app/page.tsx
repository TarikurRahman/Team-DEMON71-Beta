    ...
    >
      {[
        { 
          ...
          image: "/images/rover.jpg" // এখানে আপনার ইমেজের পাথ দিন
        },
        { 
...
{/* ACKNOWLEDGEMENTS / SPONSORS SECTION */}
...
{/* Sponsor Cards Grid - Logo Focused */}
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
  {[
    ...
    <div key={idx} className="bg-[#111] border border-zinc-800 p-10 rounded-2xl flex flex-col items-center justify-center hover:border-[#de4030] transition-all group">
      ...
      {/* লোগো এরিয়া - লোগোর আকৃতি অনুযায়ী অটোমেটিক শেপ */}
